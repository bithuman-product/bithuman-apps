...
#   ~/bithuman/bithuman-apps/flutter/bithuman/   ← this plugin
...
Pod::Spec.new do |s|
  ...
  s.platform         = :ios, '16.0'
  s.swift_version    = '5.9'
  # The bithuman.framework references libessence symbols (via the
  ...
  # the app would link bithuman.framework but every libessence
