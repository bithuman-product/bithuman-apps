...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    try {
      flutterEngine.getPlugins().add(new ai.bithuman.bithuman_avatar.BithumanAvatarPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin bithuman_avatar, ai.bithuman.bithuman_avatar.BithumanAvatarPlugin", e);
    }
    try {
