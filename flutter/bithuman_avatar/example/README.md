# bithuman_avatar — Flutter developer demo
...
- `lib/bithuman_avatar.dart` — plugin Dart API (texture, audioStart,
...
- `macos/Classes/BithumanAvatarPlugin.swift` — Flutter texture
