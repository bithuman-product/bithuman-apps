#!/usr/bin/env bash
# e2e-all.sh — drive the bithuman_avatar Flutter example end-to-end on
...
run_macos() {
    ...
    pkill -f bithuman_avatar_example.app 2>/dev/null || true
    open "$EXAMPLE_DIR/build/macos/Build/Products/Debug/bithuman_avatar_example.app"
...
echo
echo "==================== bithuman_avatar e2e summary ===================="
printf "  %-20s  %s\n" "macOS"           "$result_macos"
